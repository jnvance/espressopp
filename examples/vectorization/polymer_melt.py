...
#  runtime details
#                                                                         #
# Note: To turn on vectorization for the LJ potential
#   python polymer_melt.py --vec
###########################################################################
...
bonds, angles, x, y, z, Lx, Ly, Lz = espressopp.tools.lammps.read('../polymer_melt/polymer_melt.lammps')
